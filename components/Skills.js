...
const classes = {
  ...
  header:
    "relative bg-slate-100 shadow shadow-[0px,5px,45px,rgba(255,255,255,0.1)] dark:shadow dark:shadow-slate-100/50 flex justify-between w-full dark:bg-slate-700 rounded p-5 z-10",
