...
const classes = {
  links:
    "group flex m-2 bg-cyan-800 dark:bg-cyan-700 p-1 hover:shadow dark:hover:bg-cyan-800 hover:bg-cyan-900 text-slate-50 rounded px-2 border border-teal-700",
