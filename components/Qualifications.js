      ...
      <div className="font-['Helvetica'] md:flex justify-center w-[85%] md:w-[75%] m-auto mb-20">
        <div className="flex md:block">
          ...
          >
            ...
            Education
            <AiOutlineCaretRight
              className={"m-1 hidden md:block transition-transform duration-200" + (selected === "work" ? " group-hover:translate-x-1" : "")}
            />
          ...
          >
            ...
            Work
            <AiOutlineCaretRight
              className={"m-1 hidden md:block transition-transform duration-200" + (selected === "edu" ? " group-hover:translate-x-1" : "")}
            />
            <AiOutlineCaretDown className="m-1 md:hidden" />
          </button>
        </div>
          ...
          <div id="edu-section" className={classes.section + (selected === "work" ? " hidden" : " block")}>
            ...
            <div>
              ...
              <div className="flex mb-2">
                <FaBookReader className="m-1 mr-3" />
                <div className="w-fit">
                  Courses - Web Programming (Back-End), Distributed Systems and cloud computing DBMS, Web Programming 2 (Front-End), Mobile systems
                  and applications, Algorithms
                </div>
              </div>
              <div className="flex">
          ...
          <div id="work-section" className={classes.section + (selected === "edu" ? " hidden" : " block")}>
            <div>
              ...
              <div className="flex mb-2">
                ...
                <div className="w-fit">
                  <ul>
                    <li>Conducted classes and doubt sessions with students for graduate-level course Data Structures and Algorithms</li>
              ...
              <div className="flex mb-2">
                ...
                <div className="w-fit">
                  <ul>
                    ...
                    <li>Improved the response time of APIs by 200% by implementing in-memory cache using Redis, useMemo, and useCallback</li>
