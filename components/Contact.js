...
const classes = {
    ...
    submit: "bg-cyan-800 dark:hover:shadow-[0px_0px_8px_3px_rgb(21,94,117,0.4)] p-2 px-3 cursor-pointer rounded text-slate-50 m-1 flex hover:shadow-cyan-500/50 hover:shadow-md transition-all duration-200",
